...
const Footer = () => {
  ...
  return (
    <footer className="py-4 px-4 sm:px-6 lg:px-12 xl:px-20 2xl:px-40 bg-transparent border-t border-neutral-200 dark:border-gray-800 w-full text-black dark:text-neutral-400 ">
